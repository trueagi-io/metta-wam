...
properties('&corelib','repr', [string_operations, qhelp("Convert an atom to a string."), repr ]).
properties('&corelib','parse', [string_operations, qhelp("Convert a string to an atom."), parse ]).
