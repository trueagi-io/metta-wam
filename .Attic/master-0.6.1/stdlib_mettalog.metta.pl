%% Generated from /home/deb12user/metta-wam/prolog/metta_lang/stdlib_mettalog.metta at 2025-05-30T23:04:44-07:00
...
metta_other_asserted('&corelib',[iz,'random-int','MeTTa']).
...
metta_other_asserted('&corelib',[iz,'random-float','MeTTa']).
