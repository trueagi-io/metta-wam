...
namespace MettaLogTests
{
    public static class example2
    {
        static example2()
        {
            Console.WriteLine("MettaLogTests::example2.<clinit>()");
        }
        ...
        {
            Console.WriteLine("MettaLogTests::example2.install()");
            //Console.WriteLine("example2::install press ctrol-D to leave CSharp");
