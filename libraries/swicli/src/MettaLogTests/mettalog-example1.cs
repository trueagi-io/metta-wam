...
namespace MettaLogTests
{
    public static class example1
    {
        static example1()
        {
            Console.WriteLine("MettaLogTests::example1.<clinit>()");
        }
        ...
        {
            Console.WriteLine("MettaLogTests::example1.install()");
            //Console.WriteLine("example1::install press ctrol-D to leave CSharp");
