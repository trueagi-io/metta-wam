...
{
    public static class SWICLITestProg
    {
        static SWICLITestProg()
        {
            Console.WriteLine("SWICLITestDLL::SWICLITestProg.<clinit>()");
        }
        public static void install()
        {
            Console.WriteLine("SWICLITestDLL::SWICLITestProg.install()");
            //NonDetExample.LoadNonDetExamples();
            Console.WriteLine("SWICLITestProg::install press ctrol-D to leave CSharp");
