...
:- multifile(old_compile_flow_control/8).
:- discontiguous(old_compile_flow_control/8).
...
:- forall(is_a_mc_f(MF),forall(between(1,12,N), decl_ddm(MF,N))).
:- forall(is_a_mc_f_va(MF),forall(between(3,12,N), decl_ddm(MF,N))).


each_recompile :- ensure_mc_updated_now.
ensure_mc_updated_now:-
  forall(is_a_mc_f(FA), ensure_mc_fa(FA)),
  forall(is_a_mc_f_va(FA), ensure_mc_va(FA)),!.
ensure_mc_fa(FA):- forall(between(1,12,N),ensure_mc_fa(FA,N)).
ensure_mc_fa(FA,N):- succ(N,M),functor(P,FA,M),arg(1,P,Rel),forall(clause(P,_),ensure_mc_fa(FA,N,Rel)).
ensure_mc_fa(FA,N,Rel):- atom(Rel),assert(has_fa(Rel,N,FA)).

ensure_mc_va(FA):- forall(between(3,12,N),ensure_mc_va(FA,N)).
ensure_mc_va(FA,N):- succ(N,M),functor(P,FA,M),arg(1,P,Rel),forall(clause(P,_),ensure_mc_va(FA,N,Rel)).
ensure_mc_va(FA,N,Rel):- atom(Rel),assert(has_va(Rel,N,FA)).
...
mo(F, R) :- call_by_ftype(F, 0, mc(F, R), R).
mo(F, X0, R) :- call_by_ftype(F, 1, mc(F, X0, R), R).
mo(F, X0, X1, R) :- call_by_ftype(F, 2, mc(F, X0, X1, R), R).
mo(F, X0, X1, X2, R) :- call_by_ftype(F, 3, mc(F, X0, X1, X2, R), R).
mo(F, X0, X1, X2, X3, R) :- call_by_ftype(F, 4, mc(F, X0, X1, X2, X3, R), R).
mo(F, X0, X1, X2, X3, X4, R) :- call_by_ftype(F, 5, mc(F, X0, X1, X2, X3, X4, R), R).
mo(F, X0, X1, X2, X3, X4, X5, R) :- call_by_ftype(F, 6, mc(F, X0, X1, X2, X3, X4, X5, R), R).
mo(F, X0, X1, X2, X3, X4, X5, X6, R) :- call_by_ftype(F, 7, mc(F, X0, X1, X2, X3, X4, X5, X6, R), R).
mo(F, X0, X1, X2, X3, X4, X5, X6, X7, R) :- call_by_ftype(F, 8, mc(F, X0, X1, X2, X3, X4, X5, X6, X7, R), R).
mo(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, R) :- call_by_ftype(F, 9, mc(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, R), R).
mo(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, R) :- call_by_ftype(F, 10, mc(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, R), R).
...
ml(F, X0, [F, X0]).
ml(F, X0, X1, [F, X0, X1]).
ml(F, X0, X1, X2, [F, X0, X1, X2]).
ml(F, X0, X1, X2, X3, [F, X0, X1, X2, X3]).
ml(F, X0, X1, X2, X3, X4, [F, X0, X1, X2, X3, X4]).
ml(F, X0, X1, X2, X3, X4, X5, [F, X0, X1, X2, X3, X4, X5]).
ml(F, X0, X1, X2, X3, X4, X5, X6, [F, X0, X1, X2, X3, X4, X5, X6]).
ml(F, X0, X1, X2, X3, X4, X5, X6, X7, [F, X0, X1, X2, X3, X4, X5, X6, X7]).
ml(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, [F, X0, X1, X2, X3, X4, X5, X6, X7, X8]).
ml(F, X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, [F, X0, X1, X2, X3, X4, X5, X6, X7, X8, X9]).
...
as_p1_exec(X,Y):- is_list(X),!,eval(X,Y).
as_p1_exec(X,Y):- \+ compound(X),!,eval(X,Y).
as_p1_exec(X,Y):- retrace,!,eval(X,Y).

% Main Logic
call_by_ftype(F, Len, Goal, ReturnVal) :-
   catch(call_by_ftype_throws(F, Len, Goal, ReturnVal),metta_notreducable(NR),ReturnVal=NR).
call_by_ftype_throws(F, Len, Goal, ReturnVal) :-
...
score_head_match(A,B,C):- var(A),var(B),!, C=1.0.
score_head_match(A,B,C):- A=@=B,!, C=1.0.
score_head_match(A,B,C):- (var(A);var(B)),!,C=0.5.
score_head_match(A,B,C):- (A==[];B==[]),!,C=0.5.
score_head_match([A|AA],[B|BB],CCC):- score_head_match(A,B,C),score_head_match(AA,BB,CC), !, CCC is C * CC.

mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7,X8,X9],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7,X8,X9],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7,X8,X9],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7,X8,X9],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_fa(F,10,mo,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7,X8],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7,X8],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7,X8],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7,X8],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_fa(F,9,mo,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_fa(F,8,mo,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6],ROut).
mo(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_fa(F,7,mo,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,ROut).
mo(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5],ROut).
mo(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5],ROut).
mo(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5],ROut).
mo(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5],ROut).
mo(F,X0,X1,X2,X3,X4,X5,ROut):-decl_fa(F,6,mo,Op),call(Op,F,X0,X1,X2,X3,X4,X5,ROut).
mo(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3,X4],ROut).
mo(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3,X4],ROut).
mo(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3,X4],ROut).
mo(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3,X4],ROut).
mo(F,X0,X1,X2,X3,X4,ROut):-decl_fa(F,5,mo,Op),call(Op,F,X0,X1,X2,X3,X4,ROut).
mo(F,X0,X1,X2,X3,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[X3],ROut).
mo(F,X0,X1,X2,X3,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2,X3],ROut).
mo(F,X0,X1,X2,X3,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2,X3],ROut).
mo(F,X0,X1,X2,X3,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2,X3],ROut).
mo(F,X0,X1,X2,X3,ROut):-decl_fa(F,4,mo,Op),call(Op,F,X0,X1,X2,X3,ROut).
mo(F,X0,X1,X2,ROut):-decl_va(F,3,mo,Op),call(Op,3,F,X0,X1,X2,[],ROut).
mo(F,X0,X1,X2,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[X2],ROut).
mo(F,X0,X1,X2,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1,X2],ROut).
mo(F,X0,X1,X2,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1,X2],ROut).
mo(F,X0,X1,X2,ROut):-decl_fa(F,3,mo,Op),call(Op,F,X0,X1,X2,ROut).
mo(F,X0,X1,ROut):-decl_va(F,2,mo,Op),call(Op,2,F,X0,X1,[],ROut).
mo(F,X0,X1,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[X1],ROut).
mo(F,X0,X1,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0,X1],ROut).
mo(F,X0,X1,ROut):-decl_fa(F,2,mo,Op),call(Op,F,X0,X1,ROut).
mo(F,X0,ROut):-decl_va(F,1,mo,Op),call(Op,1,F,X0,[],ROut).
mo(F,X0,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[X0],ROut).
mo(F,X0,ROut):-decl_fa(F,1,mo,Op),call(Op,F,X0,ROut).
mo(F,ROut):-decl_va(F,0,mo,Op),call(Op,0,F,[],ROut).
mo(F,ROut):-decl_fa(F,0,mo,Op),call(Op,F,ROut).

s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7,X8,X9],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7,X8,X9],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7,X8,X9],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7,X8,X9],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut):-decl_fa(F,10,s,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,X8,X9,ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7,X8],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7,X8],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7,X8],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7,X8],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut):-decl_fa(F,9,s,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,X8,ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6,X7],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6,X7],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6,X7],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6,X7],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,X7,ROut):-decl_fa(F,8,s,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,X7,ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5,X6],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5,X6],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5,X6],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5,X6],ROut).
s(F,X0,X1,X2,X3,X4,X5,X6,ROut):-decl_fa(F,7,s,Op),call(Op,F,X0,X1,X2,X3,X4,X5,X6,ROut).
s(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4,X5],ROut).
s(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4,X5],ROut).
s(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4,X5],ROut).
s(F,X0,X1,X2,X3,X4,X5,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4,X5],ROut).
s(F,X0,X1,X2,X3,X4,X5,ROut):-decl_fa(F,6,s,Op),call(Op,F,X0,X1,X2,X3,X4,X5,ROut).
s(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3,X4],ROut).
s(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3,X4],ROut).
s(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3,X4],ROut).
s(F,X0,X1,X2,X3,X4,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3,X4],ROut).
s(F,X0,X1,X2,X3,X4,ROut):-decl_fa(F,5,s,Op),call(Op,F,X0,X1,X2,X3,X4,ROut).
s(F,X0,X1,X2,X3,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[X3],ROut).
s(F,X0,X1,X2,X3,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2,X3],ROut).
s(F,X0,X1,X2,X3,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2,X3],ROut).
s(F,X0,X1,X2,X3,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2,X3],ROut).
s(F,X0,X1,X2,X3,ROut):-decl_fa(F,4,s,Op),call(Op,F,X0,X1,X2,X3,ROut).
s(F,X0,X1,X2,ROut):-decl_va(F,3,s,Op),call(Op,3,F,X0,X1,X2,[],ROut).
s(F,X0,X1,X2,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[X2],ROut).
s(F,X0,X1,X2,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1,X2],ROut).
s(F,X0,X1,X2,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1,X2],ROut).
s(F,X0,X1,X2,ROut):-decl_fa(F,3,s,Op),call(Op,F,X0,X1,X2,ROut).
s(F,X0,X1,ROut):-decl_va(F,2,s,Op),call(Op,2,F,X0,X1,[],ROut).
s(F,X0,X1,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[X1],ROut).
s(F,X0,X1,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0,X1],ROut).
s(F,X0,X1,ROut):-decl_fa(F,2,s,Op),call(Op,F,X0,X1,ROut).
s(F,X0,ROut):-decl_va(F,1,s,Op),call(Op,1,F,X0,[],ROut).
s(F,X0,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[X0],ROut).
s(F,X0,ROut):-decl_fa(F,1,s,Op),call(Op,F,X0,ROut).
s(F,ROut):-decl_va(F,0,s,Op),call(Op,0,F,[],ROut).
...
decl_va_1(F,A,MI,MC):- has_va(F,A,MC),!,MI\==MC.
%decl_va_1(_,_,s,mi).
%decl_va_1(_,_,mi,mc):- trace.
...
old_compile_flow_control(HeadIs,LazyVars,RetResult,RetResultN,LazyEval,Convert, Converted, ConvertedN) :-
...
old_compile_test_then_else(HeadIs,RetResult,RetResultN,LazyVars,LazyEval,If,Then,Else,Converted, ConvertedN):-
...
old_compile_flow_control(HeadIs,LazyVars,RetResult,RetResultN,LazyEval,Convert,Converted,ConvertedN) :-
   ...
   old_compile_flow_control_case(HeadIs,LazyVars,RetResult,RetResultN,LazyEval,ValueResult1a,Cases,Converted0,Converted0N),
   append(ValueCode1a,Converted0,Converted),
   append(ValueCode1a,Converted0N,ConvertedN).

old_compile_flow_control_case(_,_,RetResult,RetResultN,x(doeval,eager,[]),_,[],[[assign,RetResult,'Empty']],[[assign,RetResultN,'Empty']]) :- !.
old_compile_flow_control_case(HeadIs,LazyVars,RetResult,RetResult,LazyEval,ValueResult,[[Match,Target]|Rest],Converted,ConvertedN) :-
   ...
   old_compile_flow_control_case(HeadIs,LazyVars,RestResult,RestResultN,LazyEval1,ValueResult,Rest,RestCode,RestCodeN),
...
/*
old_compile_flow_control(HeadIs,LazyVars,RetResult,LazyEval,Convert, Converted) :-
...
todo_old_compile_flow_control(_HeadIs, _LazyVars, RetResult, _RetResultN, _ResultLazy, Convert, [inline(Converted)], _ConvertedN) :-
...
todo_old_compile_flow_control(HeadIs, _LazyVars, RetResult, _RetResultN, _ResultLazy, Convert, [inline(Converted)], _ConvertedN) :-
...
old_compile_flow_control(HeadIs,LazyVars,RetResult,RetResultN,LazyRetQuoted,Convert, QuotedCode1a, QuotedCode1N) :-
...
maybe_throw_bind(Var,Copy,NewValue):-  fail_bind(Var,Copy,NewValue).
%maybe_throw_bind(Var,Copy,NewValue):-  throw_bind(Var,Copy,NewValue).
...
cant_bind_e1(_E1,_Var,Copy,NewValue):- var(NewValue),Copy=@=NewValue,!.
cant_bind_e1(_E1,_Var,_Copy,NewValue):- var(NewValue),!.
cant_bind_e1( E1, Var,Copy,NewValue):- atom(NewValue), !, call(E1,Var,Copy,NewValue).
cant_bind_e1( E1, Var,Copy,NewValue):- trace, call(E1,Var,Copy,NewValue).
...
ss_unfreeze_vars(Term):-
   term_attvars(Term,AVs),maplist(remove_attr(cant_bind),AVs).
